...
function check_login_candi($dbc, $username = '', $pass = '') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		$q1 = "SELECT candidate_id, username FROM talent_candidate WHERE username='$u' AND password=SHA1('$p')";		
...
//------------------------------------------------------------------------------------------------------
 ...
 function check_login($dbc, $username = '', $pass = '') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		$q = "SELECT admin_id, username FROM admin WHERE username='$u' AND password='$p'";		
